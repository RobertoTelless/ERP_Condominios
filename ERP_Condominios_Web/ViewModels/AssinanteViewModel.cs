...
namespace ERP_Condominios_Solution.ViewModels
{
    public class AssinanteViewModel
    {
        ...
        [StringLength(20, MinimumLength = 1, ErrorMessage = "O NÚMERO deve conter no minimo 3 e no máximo 50 caracteres.")]
        ...
        [Required(ErrorMessage = "Campo TIPO DE CONDMÍNIO obrigatorio")]
